'use strict';var AsBindIIFE=function(t){function x(a,b){var d=new Uint32Array(a);a=new Uint16Array(a);d=d[b+-4>>>2]>>>1;b>>>=1;if(1024>=d)return String.fromCharCode.apply(String,a.subarray(b,b+d));let c=[];do{var f=a[b+1024-1];f=55296<=f&&56320>f?1023:1024;c.push(String.fromCharCode.apply(String,a.subarray(b,b+=f)));d-=f}while(1024<d);return c.join("")+String.fromCharCode.apply(String,a.subarray(b,b+d))}function u(a){function b(a,b){return a?x(a.buffer,b):"<yet unknown>"}let d={},c=a.env=a.env||{};
c.abort=c.abort||function(a,h,g,e){let f=d.memory||c.memory;throw Error("abort: "+b(f,a)+" at "+b(f,h)+":"+g+":"+e);};c.trace=c.trace||function(a,h){console.log("trace: "+b(d.memory||c.memory,a)+(h?" ":"")+Array.prototype.slice.call(arguments,2,2+h).join(", "))};a.Math=a.Math||Math;a.Date=a.Date||Date;return d}function v(a,b){function d(a){let b=new Uint32Array(m.buffer),d=b[p>>>2];if((a>>>=0)>=d)throw Error("invalid id: "+a);return b[(p+4>>>2)+2*a]}function c(a){let b=new Uint32Array(m.buffer),d=
b[p>>>2];if((a>>>=0)>=d)throw Error("invalid id: "+a);return b[(p+4>>>2)+2*a+1]}function f(a,b,d){let c=m.buffer;if(d)switch(a){case 2:return new Float32Array(c);case 3:return new Float64Array(c)}else switch(a){case 0:return new (b?Int8Array:Uint8Array)(c);case 1:return new (b?Int16Array:Uint16Array)(c);case 2:return new (b?Int32Array:Uint32Array)(c);case 3:return new (b?BigInt64Array:BigUint64Array)(c)}throw Error("unsupported align: "+a);}function h(a){let b=new Uint32Array(m.buffer);var c=b[a+
-8>>>2];let e=d(c);if(!(e&1))throw Error("not an array: "+c);c=31-Math.clz32(e>>>5&31);var n=b[a+4>>>2];a=e&2?b[a+12>>>2]:b[n+-4>>>2]>>>c;return f(c,e&1024,e&2048).subarray(n>>>=c,n+a)}function g(a,b,c){return new a(e(a,b,c))}function e(a,b,c){let d=m.buffer,e=new Uint32Array(d);c=e[c+4>>>2];return new a(d,c,e[c+-4>>>2]>>>b)}b=b.exports;let m=b.memory,k=b.table,w=b.__alloc,y=b.__retain,p=b.__rtti_base||-1;a.__allocString=function(a){let b=a.length,c=w(b<<1,1),d=new Uint16Array(m.buffer);for(var e=
0,f=c>>>1;e<b;++e)d[f+e]=a.charCodeAt(e);return c};a.__getString=function(a){let b=m.buffer;if(1!==(new Uint32Array(b))[a+-8>>>2])throw Error("not a string: "+a);return x(b,a)};a.__allocArray=function(a,b){var c=d(a);if(!(c&3))throw Error("not an array: "+a+" @ "+c);let e=31-Math.clz32(c>>>5&31),g=b.length,h=w(g<<e,0);a=w(c&2?16:12,a);var n=new Uint32Array(m.buffer);n[a+0>>>2]=y(h);n[a+4>>>2]=h;n[a+8>>>2]=g<<e;c&2&&(n[a+12>>>2]=g);n=f(e,c&1024,c&2048);if(c&8192)for(c=0;c<g;++c)n[(h>>>e)+c]=y(b[c]);
else n.set(b,h>>>e);return a};a.__getArrayView=h;a.__getArray=function(a){a=h(a);let b=a.length,c=Array(b);for(let d=0;d<b;d++)c[d]=a[d];return c};a.__getArrayBuffer=function(a){let b=m.buffer,c=(new Uint32Array(b))[a+-4>>>2];return b.slice(a,a+c)};a.__getInt8Array=g.bind(null,Int8Array,0);a.__getInt8ArrayView=e.bind(null,Int8Array,0);a.__getUint8Array=g.bind(null,Uint8Array,0);a.__getUint8ArrayView=e.bind(null,Uint8Array,0);a.__getUint8ClampedArray=g.bind(null,Uint8ClampedArray,0);a.__getUint8ClampedArrayView=
e.bind(null,Uint8ClampedArray,0);a.__getInt16Array=g.bind(null,Int16Array,1);a.__getInt16ArrayView=e.bind(null,Int16Array,1);a.__getUint16Array=g.bind(null,Uint16Array,1);a.__getUint16ArrayView=e.bind(null,Uint16Array,1);a.__getInt32Array=g.bind(null,Int32Array,2);a.__getInt32ArrayView=e.bind(null,Int32Array,2);a.__getUint32Array=g.bind(null,Uint32Array,2);a.__getUint32ArrayView=e.bind(null,Uint32Array,2);F&&(a.__getInt64Array=g.bind(null,BigInt64Array,3),a.__getInt64ArrayView=e.bind(null,BigInt64Array,
...
{this.exports[a].shouldCacheTypes=!1})}enableImportFunctionTypeCaching(){r(this.importObject,[],(a,b,d)=>{a[d].shouldCacheTypes=!0})}disableImportFunctionTypeCaching(){r(this.importObject,[],(a,b,d)=>{a[d].shouldCacheTypes=!1})}}let E={version:"0.2.0",instantiate:async(a,b)=>{let d=new D;await d._instantiate(a,b);return d},instantiateSync:(a,b)=>{let d=new D;d._instantiateSync(a,b);return d}};t.AsBind=E;t.default=E;return t}({});
